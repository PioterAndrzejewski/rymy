...
// Web Speech API — `lib.dom` w TS 5.7 wciąż tego nie ma, a nie chcemy dokładać
// @types/dom-speech-recognition dla czterech interfejsów. Minimum, którego
// używa `useSpeechInput`.
